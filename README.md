...
Once the server builds successfully, a folder `blacklab-indexes` will be generated by and used by the blacklab server (i.e. its corresponding Docker container).
